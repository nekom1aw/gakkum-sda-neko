<div x-data="{ showToast : true }" x-init="setTimeout(() => showToast = false, 2000)"
    ...
    <div class="px-6 py-16 lg:px-10">
        ...
        <div class="flex items-start justify-between gap-6">
            ...
            <!-- BUTTON -->
            <a href="{{ route('cms.investigasi.insert', [
...
<div class="flex h-full w-[350px] flex-col border-b border-gray-300 pb-8">
    ...
    <!-- IMAGE -->
    <a
        href="{{ route('cms.investigasi.detail', [
            'locale' => app()->getLocale(),
            'id' => $item->id
        ]) }}"
    ...
    <div class="flex flex-1 flex-col">
        ...
        <div class="mt-auto flex items-center justify-between pt-6">
            ...
            <button
                ...
                wire:confirm="Yakin ingin menghapus investigasi ini?"
            ...
            @empty
                ...
                <div class="col-span-3 py-20 text-center">
                    ...
                    <p class="mt-2 text-gray-500">
                        Silakan tambahkan investigasi baru.
                    </p>
