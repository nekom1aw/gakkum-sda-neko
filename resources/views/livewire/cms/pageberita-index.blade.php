<div x-data="{ showToast: true }" x-init="setTimeout(() => showToast = false, 2000)"
    ...
    <div class="px-6 py-20 lg:px-10">
        ...
        <div class="flex items-start justify-between">
            ...
            <!-- BUTTON -->
            <a href="{{ route('cms.berita.insert', [
            ...
            @forelse($berita as $item)
                    ...
                    : $item->title_en }}
                            ...
                            <div class="mt-2 h-[40px] flex items-center gap-2 text-[16px]">
                                ...
                                <span class="font-bold text-[#6D9B63]">
                    ...
                    'id' => $item->id
                                    ...
                                    <button wire:click="delete({{ $item->id }})" wire:confirm="Yakin ingin menghapus berita ini?"
