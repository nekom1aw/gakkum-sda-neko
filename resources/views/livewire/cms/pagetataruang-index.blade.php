<div x-data="{ showToast: true }" x-init="setTimeout(() => showToast = false, 2000)"
    ...
    <div class="px-6 py-20 lg:px-10">
        <div class="flex items-start justify-between gap-6">
            ...
            <a href="{{ route('cms.sektor.tata-ruang.insert', ['locale' => app()->getLocale()]) }}"
                    ...
                    <div class="mt-2 flex items-center justify-between gap-4">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <button wire:click="delete({{ $item->id }})"
                                wire:confirm="Yakin ingin menghapus tata ruang ini?"
            ...
            @empty
                <div class="col-span-3 py-20 text-center">
                    <p class="text-[24px] font-bold text-gray-900">
                        Belum Ada Tata Ruang
                    </p>

                    <p class="mt-2 text-gray-500">
                        Silakan tambahkan data tata ruang baru.
                    </p>
                </div>
            @endforelse
        </div>
