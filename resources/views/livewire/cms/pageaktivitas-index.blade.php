        ...
        <div class="mt-4 grid grid-cols-1 items-start gap-x-4 gap-y-20 md:grid-cols-2 lg:grid-cols-3">
            ...
            @forelse($data as $item)
                ...
                <div class="flex h-full w-[350px] flex-col border-b border-gray-300 pb-8">
                    ...
                    {{-- image --}}
                    <a
                        href="{{ route('cms.aktivitas.detail', [
                            'locale' => app()->getLocale(),
                            'id' => $item->id
                        ]) }}"
                    ...
                    <div class="flex flex-1 flex-col">
                        ...
                        >
                            ...
                            <p
                                class="mt-3 h-[110px] w-full overflow-hidden text-xl leading-relaxed font-bold text-[#2E2E2E]"
                            >
                        ...
                        <div class="mt-auto flex items-center justify-between pt-6">
                            ...
                            <button
                                ...
                                wire:confirm="Yakin ingin menghapus aktivitas ini?"
            ...
            @empty
                ...
                <div class="col-span-3 py-20 text-center">
                    ...
                    <p class="mt-2 text-gray-500">
                        Silakan tambahkan aktivitas baru.
                    </p>
