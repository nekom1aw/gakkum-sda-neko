        ...
        <form wire:submit.prevent="update" class="px-6 py-6 space-y-8">
            ...
            <div x-show="lang === 'id'" class="space-y-8">
                ...
                <div>
                    ...
                    <x-tinymce id="pencemaran_edit_description_id_editor" model="description_id" />
                </div>
                ...
                <div>
                    ...
                    <x-tinymce id="pencemaran_edit_source_id_editor" model="source_id" />
                </div>
            </div>
            ...
            <div x-show="lang === 'en'" class="space-y-8">
                ...
                <div>
                    ...
                    <x-tinymce id="pencemaran_edit_description_en_editor" model="description_en" />
                </div>
                ...
                <div>
                    ...
                    <x-tinymce id="pencemaran_edit_source_en_editor" model="source_en" />
                </div>
            </div>
