<div class="bg-white py-20">
    <div class="max-w-7xl mx-auto px-6 lg:px-10">
        <div class="flex items-center justify-between gap-6 mb-4">
            ...
            <a href="{{ route('cms.sektor.pencemaran.edit', [
        ...
        <div class="max-w-4xl">
            <h1 class="text-[34px] lg:text-[42px] font-black text-[#007A63] leading-[1.2]">
                {{ app()->getLocale() === 'id' ? $pencemaran->title_id : $pencemaran->title_en }}
            </h1>

            @if(app()->getLocale() === 'id' ? $pencemaran->description_id : $pencemaran->description_en)
                <div class="mt-8 prose max-w-none text-[18px] leading-[2] text-gray-700">
                    {!! app()->getLocale() === 'id' ? $pencemaran->description_id : $pencemaran->description_en !!}
                </div>
            @endif

            @php($source = app()->getLocale() === 'id' ? $pencemaran->source_id : $pencemaran->source_en)
