<div class="leading-relaxed">
    ...
    : $investigasi->title_en }}" class="h-[600px] w-full object-cover">
    ...
    : $investigasi->title_en }}
                ...
                <div class="mt-8 flex items-center gap-4">
                    ...
                    <!-- EDIT -->
                    <a href="{{ route('cms.investigasi.edit', [
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-24 pb-24">
            ...
            <div class="mt-14 grid grid-cols-1 gap-x-12 gap-y-20 md:grid-cols-2 lg:grid-cols-3">
                ...
                @foreach($lainnya as $item)
                        ...
                        <!-- CARD -->
                        <a href="{{ route('cms.investigasi.detail', [
                        'locale' => app()->getLocale(),
                        'id' => $item->id
                    ]) }}" class="block">
