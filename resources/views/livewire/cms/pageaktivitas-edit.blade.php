    ...
    <div class="bg-white border border-gray-200">
        ...
        <form wire:submit.prevent="update" class="px-6 py-6 space-y-8">
            ...
            <div x-show="lang === 'id'" class="space-y-4">
                ...
                <div class="w-[220px] border border-gray-200 bg-white p-3">
                    ...
                    @else
                        ...
                        <img
                            src="{{ asset('storage/' . $old_image_id) }}"
                            class="h-[300px] w-full object-cover"
                        >
            ...
            <div x-show="lang === 'en'" class="space-y-4">
                ...
                <div class="w-[220px] border border-gray-200 bg-white p-3">
                    ...
                    @else
                        ...
                        <img
                            src="{{ asset('storage/' . $old_image_en) }}"
                            class="h-[300px] w-full object-cover"
                        >
            ...
            <div class="flex justify-end">
                ...
                <button
                    type="submit"
                    class="h-[52px] bg-[#00594B] px-6 text-[15px] font-semibold uppercase text-white"
                >
                    Update Aktivitas
                </button>
