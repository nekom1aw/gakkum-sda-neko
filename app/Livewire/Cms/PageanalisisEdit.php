...
class PageanalisisEdit extends Component
{
    use WithFileUploads;
    ...
    public function mount($id)
    {
        ...
        $this->status = $analisis->status;

        $this->title_id = $analisis->title_id;
        $this->title_en = $analisis->title_en;

        $this->description_id = $analisis->description_id;
        $this->description_en = $analisis->description_en;

        $this->content_id = $analisis->content_id;
        $this->content_en = $analisis->content_en;

        $this->old_image_id = $analisis->image_id;
        $this->old_image_en = $analisis->image_en;
    ...
    public function update()
    {
        ...
        session()->flash(
            'success',
            'Analisis berhasil diupdate.'
        );

        return redirect()->route('cms.analisis.detail', [
    ...
    {
        return view('livewire.cms.pageanalisis-edit');
    }
}