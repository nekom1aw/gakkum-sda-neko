...
class PagebincanghukumEdit extends Component
{
    use WithFileUploads;
    ...
    public function update()
    {
        ...
        session()->flash(
            'success',
            'Bincang hukum berhasil diupdate.'
        );

        return redirect()->route('cms.bincanghukum.detail', [
    ...
    {
        return view('livewire.cms.pagebincanghukum-edit');
    }
}